        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.distance_traveled,
            }}
            name="distance_traveled"
            error={formik.errors?.distance_traveled}
            value={formik.values?.distance_traveled}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('distance_traveled', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
